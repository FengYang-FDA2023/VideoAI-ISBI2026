...
<h5 class="pageTitle" style="color: #2c3e50;">Rationale  </h5>
  ...
  <section class="topics">
    ...
    <ul>
      ...
      <li>Frameworks for uncertainty analysis and interpretability</li>
...
<section class="paper-format">
  ...
  <section class="important-dates">
    ...
    <ul>
    <li><strong>Full paper deadline:</strong> <s>Feb 15, 2026</s> March 8, 2026 </li>
    <li><strong>Notification of acceptance:</strong> <s>Feb 28, 2026</s> March 11, 2026 </li>
    <li><strong>Camera-ready deadline:</strong> March 14, 2026 (No deadline extension)</li>
